...
class M_cik extends CI_Model
{
	...
	function import_from_dpa($id_skpd, $ta){
		...
		foreach ($cik_baru as $row) {
			...
			$query = "INSERT INTO tx_cik_indikator_prog_keg(id_prog_keg, indikator, satuan_target, target, id_indikator_dpa) SELECT ?, indikator,
			          satuan_target, target, tx_dpa_indikator_prog_keg.id FROM tx_dpa_indikator_prog_keg WHERE id_prog_keg=?";
