...
?>
	<tr>
		...
		<th colspan="6">Rencana Tahun <?php echo $tahun_rka?></th>
...
<?php	
	foreach ($program as $row) {
		$result = $this->m_dpa_perubahan->get_kegiatan_skpd_4_cetak($row->id);		
		$kegiatan = $result->result();
		$indikator_program = $this->m_dpa_perubahan->get_indikator_prog_keg($row->id, FALSE, TRUE);
...
?>
	<tr>
		...
		<td style="border-bottom: 0;" align="right" rowspan="<?php echo $total_temp; ?>"><?php echo Formatting::currency($row->sum_nominal_1);?></td>
        <td style="border-bottom: 0;" align="right" rowspan="<?php echo $total_temp; ?>"><?php echo Formatting::currency($row->sum_nominal_2);?></td>
        <td style="border-bottom: 0;" align="right" rowspan="<?php echo $total_temp; ?>"><?php echo Formatting::currency($row->sum_nominal_3);?></td>
        <td style="border-bottom: 0;" align="right" rowspan="<?php echo $total_temp; ?>"><?php echo Formatting::currency($row->sum_nominal_4);?></td>
		<td style="border-bottom: 0;" rowspan="<?php echo $total_temp; ?>"><?php echo $row->catatan_1;?></td>
	</tr>
<?php
...
<?php
		...
		foreach ($kegiatan as $row) {						
			$indikator_kegiatan = $this->m_dpa_perubahan->get_indikator_prog_keg($row->id, FALSE, TRUE);
