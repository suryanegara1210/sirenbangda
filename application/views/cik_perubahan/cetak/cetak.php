...
<div>
	<table class="full_width no-border" style="font-size: 14px;">
    	<tr>
        	<th colspan="12" align="center"><?php echo "LAPORAN CAPAIAN INDIKATOR KINERJA BELANJA LANGSUNG PERUBAHAN"; ?></th>
        </tr>
        <tr>
        	<th colspan="12" align="center"><?php echo "TAHUN ANGGARAN ".$tahun; ?></th>
        </tr>
        <tr>
    	...
    	<tr>
<th colspan="12" align="left">BULAN : <?php 
		switch($bulan){
			case '1';
			default:
				echo "JANUARI";
