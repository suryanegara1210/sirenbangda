<script type="text/javascript">
	...
	function edit_rka(id){
		window.location = '<?php echo base_url('rka_perubahan/edit_rka/');?>' + '/' + id;		
	}
...
<article class="module width_full">
	<header>
	  <h3>Tabel Data RKA Perubahan</h3>
	</header>
	<div style='float:right'><a href="<?php echo site_url('rka_perubahan/cru_rka')?>">Tambah Data RKA</a></div><br>
