...
<article class="module width_full" style="width:130%; margin-left: -15%;">
	<header>
		<h3>
			Tabel Rekapitulasi CIK
		</h3>
	</header>
	<div class="module_content" style="overflow:auto">
	<div style='float:right'>
		<a href="<?php echo site_url('cik/do_cetak_rekap_cik') ?>"><input style="margin: 3px 10px 0px 0px; float: right;" type="button" value="Cetak Rekapitulasi CIK" /></a>
    </div><br><br>
