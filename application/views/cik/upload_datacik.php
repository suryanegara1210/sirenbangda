...
<div style="width: 900px">
	<header>
		<h3>Upload File CIK</h3>
	</header>
    <div class="module_content">
		<form action="<?php echo site_url('cik/save_file_upload_cik');?>" method="POST" name="upload" id="upload" accept-charset="UTF-8" enctype="multipart/form-data" >
