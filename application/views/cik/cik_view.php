<script type="text/javascript">
	...
	$(document).ready(function(){
	    dt = $("#cik_table").DataTable({
            ...
            "ajax": {
	            "url": "<?php echo base_url('cik/load_cik'); ?>",
	            "type": "POST"
	        }        	
	    });
	...
	function edit_cik(id){
		window.location = '<?php echo base_url('cik/edit_cik/');?>' + '/' + id;		
	}

	function delete_cik(id){
		if (confirm('Apakah anda yakin untuk menghapus data CIK ini?')) {
			$.blockUI({
...
<article class="module width_full">
	...
	<a href="<?php echo base_url('cik/cru_cik/') ?>"><input style="margin: 3px 10px 0 10px; float: right;" type="button" value="Tambah Data CIK" /></a>
    </div><br> 
