<script type="text/javascript">
	$(document).ready(function () {
		...
		$("#simpan").click(function(){
	    	...
	    	$.ajax({
				type: "POST",
				url: "<?php echo site_url('cik/do_kirim_cik'); ?>",
...
<div style="width: 900px">
	...
	<div class="module_content">
		...
		Apabila CIK telah dikirim/diajukan maka fitur edit maupun fitur lainnya yang digunakan untuk mengelola CIK akan di non-aktifkan hingga terdapat proses verifikasi oleh Pihak yang memiliki kendali terhadap proses tersebut.
	</div>
	<footer>
