...
<footer>
    ...
    <?php if (!$ada_renja) {?>
    	<input type="button" class="button-action" id="get_renja" value="Ambil Data Renja" />
    <?php }?>
    <a href="<?php echo site_url('renja_perubahan/preview_renja'); ?>"><input type="button" value="Lihat Renja" /></a>
	<?php
