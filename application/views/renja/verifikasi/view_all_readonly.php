<script type="text/javascript">
	function veri_renja(id){
		window.location = '<?php echo site_url("renja/veri_readonly")?>/' + id;
	}
</script>
<article class="module width_full">
	<header>
	  <h3>Verifikasi Renja Untuk Rancangan Awal (Ranwal) READONLY</h3>
	</header>
	<div class="module_content"; style="overflow:auto">
    Berikut merupakan daftar SKPD yang sudah mengirim renja untuk di verifikasi :
