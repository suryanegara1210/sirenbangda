  ...
  $(document).ready(function(){
    ...
    $("#Kd_Urusan_autocomplete").autocomplete({
      ...
      function(req, add){
          ...
          $.ajax({
              url: "<?php echo base_url('musrenbang/musrenbangdes/autocomplete_kdurusan'); ?>",
              dataType: 'json',
              type: 'POST',
              data: req,
              success:    
    ...
    $("#Kd_Bidang_autocomplete").autocomplete({
      ...
      function(req, add){
          ...
          $.ajax({
              url: "<?php echo base_url('musrenbang/musrenbangdes/autocomplete_kdbidang'); ?>",
              dataType: 'json',
              type: 'POST',
              data: req,
              success:    
    ...
    $("#Kd_Prog_autocomplete").autocomplete({
      ...
      function(req, add){
          ...
          $.ajax({
              url: "<?php echo base_url('musrenbang/musrenbangdes/autocomplete_kdprog'); ?>",
              dataType: 'json',
              type: 'POST',
              data: req,
              success:    
    ...
    $("#Kd_Keg_autocomplete").autocomplete({
      ...
      function(req, add){
          ...
          $.ajax({
              url: "<?php echo base_url('musrenbang/musrenbangdes/autocomplete_keg'); ?>",
              dataType: 'json',
              type: 'POST',
              data: req,
              success:    
...
<header><h3>
        <?php
            if (isset($isEdit) && $isEdit){
                echo "Edit Data Musrembangdes";
            } else{
                echo "Input Data Musrembangdes";
            }
        ?>
</h3></header>
...
<tr >
    <td >Input Data Musrembangdes</td>
</tr>    
</table>
<hr />

<form id="input_musrembang" action="<?php echo site_url('musrenbang/musrenbangdes/save_rekap_keg_desa');?>" 
...
<input name='id_musrembang' type='hidden' id="id_musrembang" value="<?php echo isset($id_musrembang) ? $id_musrembang : ''?>"  />   
<div>
...
<div class="submit_link">  
      ...
      <input type=button value=Batal onclick="window.location='<?php 
        ...
        if(!empty($call_from) && strpos($call_from, 'musrenbang/musrenbangdes/create_rekap_keg_desa') == FALSE)
          echo $call_from;
        else 
          echo site_url('musrenbang/musrenbangdes/view_rekap_keg_desa');
      ?>'">
    </div> </footer>
</form>
