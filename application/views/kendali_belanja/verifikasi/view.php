...
<script type="text/javascript">
	$(document).ready(function(){		
		$(".veri_keg").click(function(){
	    	...
	    	$.ajax({
				type: "POST",
				url: "<?php echo site_url('kendali/do_veri_belanja'); ?>",
		...
		$("#kembali_all").click(function(){
			$(location).attr('href', '<?php echo site_url("kendali/veri_view_belanja"); ?>')
		});
		...
		$("#disapprove_renja").click(function(){
	    	...
	    	$.ajax({
				type: "POST",
				url: "<?php echo site_url('kendali/disapprove_belanja'); ?>",
...
<article class="module width_full" style="width: 138%; margin-left: -19%;">
	<header>
	  <h3>Verifikasi Kendali Renja</h3>
	</header>
	...
	<footer>
		<div class="submit_link">
			<input id-r="<?php echo $id_skpd; ?>" type="button" id="disapprove_renja" value="Tidak Setujui Kendali Belanja">
