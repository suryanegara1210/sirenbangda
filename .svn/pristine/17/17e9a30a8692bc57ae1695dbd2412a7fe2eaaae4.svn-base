	...
	*/
	...
	function import_from_renstra($id_skpd, $ta, $id_tahun){
		...
		foreach ($renja_baru as $row) {
			...
			$query = "INSERT INTO t_renja_indikator_prog_keg(id_prog_keg, indikator, indikator_thndpn, satuan_target, satuan_target_thndpn, target, target_thndpn, id_indikator_renstra) SELECT ?, indikator,indikator, satuan_target,satuan_target, target_$id_tahun, target_$tahun1, t_renstra_indikator_prog_keg.id FROM t_renstra_indikator_prog_keg WHERE id_prog_keg=?";
