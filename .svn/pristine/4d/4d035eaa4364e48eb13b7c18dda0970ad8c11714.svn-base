<?php 
	$max_col_keg =1;
?>
<!-- CETAK DATA REKAPITULASI SKPD DENGAN NILAI id_keputusan = 2 (DITERIMA)-->
<?php if(!empty($rekap_skpd2)){ ?>
<thead>
	<tr >
...
<tbody>
	...
	?>
			<tr >
				<td style="font-size:12px; border-bottom:0;" rowspan="<?php echo ($counter); ?>"align="center"><?php echo $row->kode_kegiatan; ?></td>
				<td style="font-size:12px; border-bottom:0;" rowspan="<?php echo ($counter); ?>"align="center">
				<?php
