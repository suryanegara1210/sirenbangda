            ...
            <div id="nav">
              ...
              <ul>
                <li> <a>[<?php echo $this->session->userdata('nama_p');?>]</a> 
                    <ul>
                    	<?php $id_skpd = $this->session->userdata('id_skpd');
							  $id_desa = $this->session->userdata('id_desa');
							  if (!empty($id_desa)){ ?>
						<li> <a href="<?php echo  base_url('users/edit_desa/edit/'.$id_desa);?> ">Edit Data Desa</a> </li>		  
						<?php }
							 if (!empty($id_skpd)){ ?>
                        <li> <a href="<?php echo  base_url('users/edit_skpd/edit/'.$id_skpd);?> ">Edit Data SKPD</a> </li>
						<?php }?>
...
$(function () {
        ...
        $('#cmb_ta').change(function() {            
            if (confirm('Apakah Anda Yakin untuk Mengganti Tahun Renja ... ?')) {
                //block page
                $.blockUI({
    ...
    <section id="main" class="column">
        ...
        <?php
         ...
         echo $contents;
        ?>
        <div class="spacer">Bappeda-Klungkung &copy; | Elapsed-Time:{elapsed_time} | Memory-Usage:{memory_usage}</div> 
    </section>    
</body>
</html>
<script type="text/javascript">
