...
<article class="module width_full" style="width: 130%; margin-left: -15%;">
	...
	<div style='float:right'>
		<a href="<?php echo site_url('kendali/kirim_veri') ?>"><input style="margin: 3px 10px 0px 0px; float: right;" type="button" value="Kirim Kendali Belanja" /></a>
				...
				<?php
					foreach ($kegiatan as $row) {
							...
							$row_count = $this->db->query("
								select * from (select id,id_dpa_prog_keg from tx_dpa_prog_keg_triwulan
