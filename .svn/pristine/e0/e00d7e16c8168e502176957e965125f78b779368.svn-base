...
<article class="module width_full" style="width: 100%;">
	...
	<table width="99.9%">        
        ...
        <td width="25%">
            ...
            <input type="button" href="<?= base_url('cik/do_export_pusat_skpd') ?>" id="export" class="btn" value="Cetak"/>
        </td>
	</table>
    </form>
    </div>
...
<script type="text/javascript">
    ...
    $("#search").click(function(){	
		...
		$.ajax({
			type: "POST",
			url : "<?php echo site_url('cik/get_data_cik_pusat_skpd')?>",
			data: data,
