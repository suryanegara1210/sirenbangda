	...
	<header>
 	...
 	<div class="module-content">
		...
		<input type="hidden" name="id_belanja_tl" value="<?php if(!empty($id_belanja_tl)){echo $id_belanja_tl;} ?>" />
            ...
            <tr>
              <td>Jenis Belanja Tidak Langsung</td>
              <td>
                <input type="text" name="jenis_belanja_tl" id="jenis_belanja_tl" placeholder="Jenis Belanja Tidak Langsung"
                value="<?php echo isset($jenis_belanja_tl) ? $jenis_belanja_tl : ''; ?>" style="width:40%"/>
              </td>
            </tr>
        <tr>
          <td colspan="2">
   	...
   	<footer>
			<div class="submit_link">
				...
				<input type="button" value="Keluar" onclick="window.location.href='<?php echo site_url('keg_belanja/belanja_tak_langsung/belanja_tak_langsung'); ?>'" />
							...
							if(!empty($call_from) && strpos($call_from, 'keg_belanja/belanja_tak_langsung/belanja_tak_langsung') == FALSE)
								echo $call_from;
							else
								echo site_url('keg_belanja/belanja_tak_langsung/belanja_tak_langsung');
							?>'"/>
				</div>
  	</footer>
</article>
