	...
	function save_kendali_renja(){
		...
		public function add_kinerja_triwulan(){
			...
			if($result_1->num_rows()==0){
				$insert_1 = "insert tx_dpa_prog_keg_triwulan(id_dpa_prog_keg,id_triwulan,anggaran) value ('".$id_dpa_prog_keg."','1',0)";
				$insert_2 = "insert tx_dpa_prog_keg_triwulan(id_dpa_prog_keg,id_triwulan,anggaran) value ('".$id_dpa_prog_keg."','2',0)";
				$insert_3 = "insert tx_dpa_prog_keg_triwulan(id_dpa_prog_keg,id_triwulan,anggaran) value ('".$id_dpa_prog_keg."','3',0)";
				$insert_4 = "insert tx_dpa_prog_keg_triwulan(id_dpa_prog_keg,id_triwulan,anggaran) value ('".$id_dpa_prog_keg."','4',0)";
