...
<div>
	<table class="full_width no-border" style="font-size: 14px;">
    	<tr>
        	<th colspan="12" align="center"><?php echo "RUMUSAN RENCANA PROGRAM DAN KEGIATAN SKPD PERUBAHAN TAHUN ".$ta; ?></th>
        </tr>
        <tr>
	...
	<table class="full_width border" style="font-size: 9px; page-break-after:always">
		<tr>
