...
<article class="module width_full">
 	...
 	<div class="module_content">
 		<form action="<?php echo site_url('renja_perubahan/save_skpd');?>" method="POST" name="renja" id="renja" accept-charset="UTF-8" enctype="multipart/form-data" >
					...
					<tr>
 					...
 					<tr class="tujuan_frame">
 						<td colspan="2">
			 				...
			 				<?php
			 					$renja_tujuan = $this->m_renja_trx_perubahan->get_each_renja_tujuan($row->id_renja, $row->id);			 					
			 				?>
